...
const GroupForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!name || userArray.some(isNaN)) {
            setErrorMessage("Please provide a valid group name and user IDs.");
            return;
        }

        try {
            console.log("Submitting data:", { name, userArray, message });
            ...
            setErrorMessage(`Failed to create group: ${error.message || "Unknown error"}`);
