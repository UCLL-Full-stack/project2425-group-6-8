-- CreateEnum
CREATE TYPE "consumableTypeEnum" AS ENUM ('FOOD', 'DRINK', 'OTHER');
...
CREATE TABLE "Item" (
    ...
    "consumableType" "consumableTypeEnum" NOT NULL,
...
-- AddForeignKey
ALTER TABLE "GroceryList" ADD CONSTRAINT "GroceryList_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "Group"("id") ON DELETE SET NULL ON UPDATE CASCADE;
